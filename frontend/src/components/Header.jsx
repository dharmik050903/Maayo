...
export default function Header({ userType, onLogout, userData }) {
  ...
  const navLinks = isAuthenticated ? (
    <>
      ...
      <button 
        ...
        className="hover:text-mint px-3 py-1 rounded-md transition-colors text-graphite relative"
      >
        Messages
  ...
  const mobileNavLinks = isAuthenticated ? (
    <>
      ...
      <button 
        onClick={handleMessagesClick}
        className="hover:text-mint px-3 py-1 rounded-md transition-colors text-center text-graphite !font-bold relative"
