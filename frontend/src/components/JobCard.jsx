        ...
        <div className="job-card-stats">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
            ...
            <div className="flex items-center gap-1">
              ...
              <span className="text-sm">{job.analytics.total_applications} applications</span>
            </div>
            <div className="flex items-center gap-1">
              <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <span className="text-sm">{job.analytics.total_views} views</span>
            </div>
          </div>
        </div>
          ...
          <div className="job-card-actions">
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
              <button
                ...
                className={`p-2 sm:p-3 rounded-xl transition-all duration-300 transform hover:-translate-y-0.5 hover:shadow-md ${
                  job.is_saved 
              ...
              <Link to={`/freelancer/jobs/${job._id}`} className="flex-1">
                <Button size="sm" className="bg-mint text-white hover:bg-mint/90 w-full">
                  View Details
                </Button>
              </Link>
            </div>
