...
const PermissionRequests = () => {
  ...
  const handleApproveReject = async (action, reviewNotes) => {
    try {
      ...
      await adminService.handlePermissionRequest(selectedRequest._id, action, reviewNotes)
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[80vh] overflow-y-auto">
        <div className="p-6 border-b border-gray-200">
          <h3 className="text-xl font-semibold text-gray-900">Review Permission Request</h3>
        </div>
        ...
        <div className="p-6">
          <div className="grid grid-cols-2 gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-gray-900">{request.targetResourceName}</p>
