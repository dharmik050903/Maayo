    ...
    <div ref={formRef} className="bg-white rounded-2xl shadow-xl p-4 sm:p-6 md:p-8 max-w-4xl mx-auto relative">
      ...
      <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 md:gap-8">
          ...
          <div className="space-y-2">
            <label htmlFor="proposed_duration" className="block text-sm font-semibold text-graphite mb-2 sm:mb-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 md:gap-8">
          <div className="space-y-2">
            <label htmlFor="start_date" className="block text-sm font-semibold text-graphite mb-2 sm:mb-3">
          ...
          <div className="space-y-2">
            <label htmlFor="availability_hours" className="block text-sm font-semibold text-graphite mb-2 sm:mb-3">
            ...
            <div className="flex items-center gap-2">
              {hasMinimumWords && (
                <button
                  ...
                  disabled={aiLoading}
                  className="px-3 sm:px-4 py-1.5 sm:py-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white text-xs sm:text-sm font-semibold rounded-lg hover:from-purple-600 hover:to-pink-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 flex items-center gap-1 sm:gap-2 shadow-lg hover:shadow-xl"
                >
                  {aiLoading ? (
                    <>
                    ...
                    <>
                      ...
                      <span className="hidden sm:inline">AI Personalized Proposal</span>
                      <span className="sm:hidden">AI Proposal</span>
                    </>
                  )}
                </button>
              )}
