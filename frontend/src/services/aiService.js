...
class AIService {
  ...
  async generateProjectDescription(data) {
    try {
      console.log('AI Service: Sending project description request with data:', data)
      
      const response = await authenticatedFetch(`${getApiBaseUrl()}/ai/generate-project-description`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
